...
Segmenting video into semantic events before embedding is promising, but should
not replace fixed-window fallback yet.
...
```text
semantic events:       Recall@1 0.400, Recall@3 0.500, Recall@10 0.900, best tIoU 0.616
semantic + transcript: Recall@1 0.400, Recall@3 0.600, Recall@10 0.900, best tIoU 0.616
fixed 30s:             Recall@1 0.300, Recall@3 0.400, Recall@10 0.700, best tIoU 0.604
fixed 120s:            Recall@1 0.600, Recall@3 1.000, Recall@10 1.000, best tIoU 0.439
fused semantic+120s:   Recall@1 0.400, Recall@3 0.500, Recall@10 1.000, best tIoU 0.641
```
...
- Fusion gives fixed-window coverage while improving localization.
